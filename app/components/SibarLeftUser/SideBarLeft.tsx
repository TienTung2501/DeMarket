...
import InfoData from "../User/InfoUser/InfoData/InfoData";
import { Fillter } from "../User/InfoUser";
...
const SideBarLeft = ({
  ...
  return (
    <div>
      <div className={`${styles.button_filter} `} onClick={handleOpenSibarLeft}>
        <HiOutlineFilter />
      </div>
      {openSibarLeft && (
        <div
        ...
        >
          ...
          {sibar_left_marketpace && (
            <div className={styles.filler}>
              <Fillter filter={dataFilter2} name_head="Category" />
            </div>
          )}
          {sibar_left_marketpace && (
            <div className={styles.filler}>
