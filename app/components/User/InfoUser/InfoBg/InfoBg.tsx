...
import {AiOutlineCamera,AiOutlineFacebook,AiOutlineTwitter} from 'react-icons/ai'
  ...
  return (
    <div className={styles.container}>
      <div className={styles.background}>
        ...
        <Image src={user.image_av} width={1536} height={2340} alt='AV'/>
        </div>
      ...
      <div className={styles.description}>
        <div className={styles.row_description}>
            <div className={styles.name}>
                ...
                <Link href={"#"}><HiOutlinePencilAlt/></Link>
            </div>
            <div className={styles.contact}>
                <div className={styles.icon}>
                   <Link href={user.link_face}> <BiLogoFacebook/></Link>
                </div>
                <div className={styles.icon}>
                    <Link href={user.link_twitter} ><AiOutlineTwitter/></Link>
                </div>
            </div>
        </div>
